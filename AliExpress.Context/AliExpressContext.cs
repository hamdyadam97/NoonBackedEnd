...
namespace AliExpress.Context
{
    public class AliExpressContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<PrdouctBrand> ProductBrands { get; set; }
       ...
       .HasForeignKey(ci => ci.CartId);
         ...
         .HasForeignKey(o => o.AppUserId);
            ...
            modelBuilder.Entity<PrdouctBrand>()
           .HasOne(p => p.Brand)
           .WithMany(b => b.PrdouctBrands) // One brand can have many products
          ...
          .HasOne(p => p.Product)
          .WithMany(b => b.Rates) // One brand can have many products

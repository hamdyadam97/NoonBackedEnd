...
{  public class Program
    {
        public static void Main(string[] args)
        {
           ...
           .AddRoles<IdentityRole>().AddEntityFrameworkStores<AliExpressContext>().AddDefaultTokenProviders();
            ...
            builder.Services.AddAutoMapper(M => M.AddProfile(typeof(MappingFavorite)));
            builder.Services.AddAutoMapper(M => M.AddProfile(typeof(MappingBrand)));
            builder.Services.AddAutoMapper(M => M.AddProfile(typeof(PrdouctBrandMapping)));
            builder.Services.AddAutoMapper(M => M.AddProfile(typeof(MappingRate)));
            ...
            builder.Services.AddScoped<IFavoriterRepository, FavoriteRepository>();
            builder.Services.AddScoped<IOrderItemRepository, OrderItemRepository>();
            builder.Services.AddScoped<IBrandRepository, BrandRepository>();
            builder.Services.AddScoped<IPrdouctBrandRepository, ProductBrandRepository>();
            ...
            builder.Services.AddScoped<IPrdouctBrandService, PrdouctBrandService>();
